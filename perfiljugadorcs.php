...
$ganados=$fila["partidos_usuario_ganadoscs"];
$perdidos=$fila["partidos_usuario_perdidoscs"];
$total = $ganados+$perdidos;
  ...
  <div class="container">
            <div class="jumbotron">
                <center> <h1>LIGA INDIVIDUAL CS</h1></center>   
            </div>
        </div>
        <div class="container">
            <div class="row">     
                <div class="col-md-6">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">    
                                    <form name="crearpartidoindividualcs" id="crearpartidoindividual" action="<?php echo $_SERVER['REQUEST_URI']?>" method="post" enctype="multipart/form-data" >
			...
			<input type="submit" id="submit" name='enviar' value="Desafiar jugador" />
                     ...
                     <div class="col-md-6">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <center><h3 class="panel-title">Estadísticas jugador</h3></center>
                                </div>
                                <div class="panel-body">    
                                    <form name="crearpartidoindividualcs" id="crearpartidoindividualcs" enctype="multipart/form-data" >
                                <div class="form-group"> 
