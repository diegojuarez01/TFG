...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    header('Location: ranking_equiposcs.php');
} 
...
if($equipopropio==""){
       ...
       setTimeout(function() {
              swal({
                  ...
                  window.location = 'ranking_equiposcs.php';
              });
          }, 200);
      </script>"; 
}else{
    ...
    //el ganador lo debera de establecer un admin despues de que se juege el partido.
      $query = "insert into partidos_equipo_cs (locales,visitantes,ganador,fecha_partido) values('$equipopropio','$retado','$ganador','$fecha')";
      $resultado = $mysqli->query($query);
if($resultado==0){
