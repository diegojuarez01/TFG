...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    header('Location: ranking_individual.php');
} 
...
//El ganador lo debera de establecer un admin despues de que se juege el partido.
    $query = "insert into partidos_individuales (jugador1,jugador2,ganador,fecha_partido) values('$retador','$retado','$ganador','$fecha')";
...
echo " <h4>Error al crear el partido.</h4><br>";
 ...
 setTimeout(function() {
        swal({
            ...
            window.location = 'ranking_individual.php';
        });
    }, 300);
</script>";	
}
