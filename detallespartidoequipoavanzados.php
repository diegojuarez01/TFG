...
$idpartidoequipo=$_GET["idpartidoequipo"];
...
$query = "select * from partidos_equipo where id_partido_equipo='$idpartidoequipo'";
$resultado = $mysqli->query($query);
if($resultado==0){
...
//Sacamos datos de cada equipo
    ...
    while($fila=$resultado->fetch_assoc()){
    $puntuacionequipo1=$fila["puntuacion"];
    }
    }
    ...
    $contador=1; 
    while($fila=$resultado->fetch_assoc()){
    $puntuacionequipo2=$fila["puntuacion"];
    }
    }
