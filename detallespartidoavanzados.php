...
if($jugador1 == $usuario OR $jugador2 == $usuario ){   
}else{
...
//Sacamos datos de cada jugador 
    ...
    while($fila=$resultado->fetch_assoc()){
    $puntuacionjugador1=$fila["puntuacion"];
    }
    }
    ...
    $contador=1; 
    while($fila=$resultado->fetch_assoc()){
    $puntuacionjugador2=$fila["puntuacion"];
    }
    }
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form id='detallespartido' action='' method='POST' enctype='multipart/form-data'>
                                    ...
                                    <div class="form-group">
                                        <label for="jugador2"> PUNTUACIÓN JUGADOR 2:</label>
