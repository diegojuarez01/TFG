<html>
   <?php
      ...
      <script>
        function MostrarRanking(num) {
            if (num == "") {
                ...
                xmlhttp.open("GET","ranking_individualajax.php?num=" + num,true);
                xmlhttp.send();
            }
	...
	?>  
        ...
        <div class="container">
            <div class="jumbotron">
                <h1>RANKING LOL LIGA INDIVIDUAL</h1>
            </div>          
        </div>
        <div class="container">
            <div class="row">
...
$query = "Select * from usuarios ORDER BY puntuacion DESC";
...
$perdidos=$row["partidos_usuario_perdidos"];
...
<tr>
    ...
    <td class='col-md-2'><a href=perfiljugador.php?nombre=$usuario></a>$puntuacion</td>
</tr>";
}
$contador=$contador+1;
}
